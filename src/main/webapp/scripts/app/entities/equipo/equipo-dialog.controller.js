...
angular.module('ligabasquetApp').controller('EquipoDialogController',
    ['$scope', '$stateParams', '$modalInstance', '$q', 'entity', 'Equipo', 'Jugador', 'Entrenador', 'Estadio', 'Partido', 'Temporada',
        function($scope, $stateParams, $modalInstance, $q, entity, Equipo, Jugador, Entrenador, Estadio, Partido, Temporada) {
