...
public class EquipoResourceTest {
    ...
    public void createEquipo() throws Exception {
        ...
        assertThat(testEquipo.getFecha().toDateTime(DateTimeZone.UTC)).isEqualTo(DEFAULT_FECHA);
    }
    ...
    public void updateEquipo() throws Exception {
        ...
        assertThat(testEquipo.getFecha().toDateTime(DateTimeZone.UTC)).isEqualTo(UPDATED_FECHA);
    }
